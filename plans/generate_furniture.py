...
FURNITURE = [
    ...
    # Болалар хонаси
    bed(6900, 5100, 8900, 6000, "left"),
    bed(7000, 2850, 9000, 3750, "left"),
    nightstand(6450, 5600, 6850, 6000, "bottom"),
    wardrobe(5930, 3950, 6530, 5500, "left"),
    desk(11210, 3900, 11810, 5300, "right"),
    chair(10960, 4550, "left"),
    shelf(9300, 5650, 10700, 6000, "bottom"),
    rug(8700, 4450, 650),
    # Меҳмонхона
