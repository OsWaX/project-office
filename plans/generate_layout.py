...
Y_H1 = (2300, 2400)    # ванна, туалет, ошхона, ётоқхона | даҳлиз
...
ROOMS = [
    ...
    ("Ошхона", room((X_V2[1], 0, X_V3[0], Y_H1[0])), (2600, 1250)),
    ...
    ("Меҳмонхона", room((0, Y_H3[1], X_V4[0], G.Y_DEPTH)), (2400, 4850)),
    ("Даҳлиз", room((G.X_L_IN, Y_H1[1], X_V4[0], Y_H3[0]),
                    (G.X_L_IN, Y_H3[0], X_V5[0], G.Y_HALL)), (2700, 3200)),
]

EXT_DIMS = DIMS[:9]
INT_DIMS = [
    # ички девор ва хоналар занжири (ванна → ётоқхона)
    ("h", [G.X_L_IN, G.X_L_IN + 250, X_V1[0], X_V1[1], X_V2[0], X_V2[1], X_V3[0], X_V3[1], G.X_KITCHEN_END], 2000, None),
    # вертикал: ошхона → даҳлиз → меҳмонхона
    ("v", [0, Y_H1[0], Y_H1[1], Y_H3[0], Y_H3[1], G.Y_DEPTH], 3500, None),
    ...
    ("h", [G.X_L_IN, OP_BATH[0], OP_BATH[1], OP_WC[0], OP_WC[1], OP_KITCHEN[0], OP_KITCHEN[1],
           OP_BED[0], OP_BED[1], X_V4[0]], 2850, Y_H1[1]),
    # меҳмонхона эшиги
...
def render_sheet():
    ...
    notes = [
        ...
        "2. Янги ички деворлар 100 мм қалинликда.",
